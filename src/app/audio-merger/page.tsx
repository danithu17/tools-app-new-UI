...
export const metadata: Metadata = {
  title: "Audio Merger - Local Audio Studio",
  description: "Combine multiple audio files into a single high-quality track locally in your browser. Supports MP3, WAV, and AAC.",
};
  ...
  return (
    <div className="flex-1 flex flex-col p-4 md:p-8 w-full max-w-6xl mx-auto min-h-[80vh]">
      <div className="mb-8 text-center max-w-2xl mx-auto">
        <h1 className="text-3xl md:text-4xl font-black text-slate-900 dark:text-white mb-2 tracking-tight">Audio Merger</h1>
        <p className="text-slate-600 dark:text-slate-400 font-medium tracking-tight">
          Bundle your recordings into a single masterpiece.
          <span className="block mt-1 font-bold text-red-500">100% Client-side. Seamless. Private.</span>
        </p>
      </div>
