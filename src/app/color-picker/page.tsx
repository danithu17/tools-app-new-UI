...
export const metadata: Metadata = {
  title: "Color Extractor - Local Image Tools",
  description: "Upload an image and instantly extract its dominant color palette. 100% private and offline. Perfect for designers.",
};
  ...
  return (
    <div className="flex-1 flex flex-col p-4 md:p-8 w-full max-w-6xl mx-auto min-h-[80vh]">
      <div className="mb-8 text-center max-w-2xl mx-auto">
        <h1 className="text-3xl md:text-4xl font-black text-slate-900 dark:text-white mb-2 tracking-tight">Color Extractor</h1>
