...
export const metadata: Metadata = {
  title: "Crontab Generator - Local Dev Tools",
  description: "Easily generate cron schedule expressions with a simple user interface. 100% private and offline.",
};
  ...
  return (
    <div className="flex-1 flex flex-col p-4 md:p-8 w-full max-w-6xl mx-auto min-h-[80vh]">
      <div className="mb-8 text-center max-w-2xl mx-auto">
        <h1 className="text-3xl md:text-4xl font-black text-slate-900 dark:text-white mb-2 tracking-tight">Crontab Generator</h1>
        <p className="text-slate-600 dark:text-slate-400 font-medium tracking-tight">
          The easiest way to generate cron job schedule expressions.
          <span className="block mt-1 font-bold text-red-500">Visual. Intuitive. Local.</span>
        </p>
      </div>
