...
export const metadata: Metadata = {
  title: "Data Converter - Pro Data Tools",
  description: "Convert between CSV, JSON, and XML formats instantly and securely. Our converter is 100% private and runs in your browser.",
};
  ...
  return (
    <div className="flex-1 flex flex-col p-4 md:p-8 w-full max-w-6xl mx-auto min-h-[80vh]">
      <div className="mb-8 text-center max-w-2xl mx-auto">
        <h1 className="text-3xl md:text-4xl font-black text-slate-900 dark:text-white mb-2 tracking-tight">Data Converter</h1>
        <p className="text-slate-600 dark:text-slate-400 font-medium tracking-tight">
          Seamlessly switch between CSV and JSON formats.
          <span className="block mt-1 font-bold text-red-500">Fast. Accurate. Secure.</span>
        </p>
      </div>
