...
export const metadata: Metadata = {
  title: "Data Visualizer - Pro Data Tools",
  description: "Turn your CSV data into beautiful charts and graphs instantly. 100% private and runs securely in your browser.",
};
  ...
  return (
    <div className="flex-1 flex flex-col p-4 md:p-8 w-full max-w-6xl mx-auto min-h-[80vh]">
      <div className="mb-8 text-center max-w-2xl mx-auto">
        <h1 className="text-3xl md:text-4xl font-black text-slate-900 dark:text-white mb-2 tracking-tight">Data Visualizer</h1>
        <p className="text-slate-600 dark:text-slate-400 font-medium tracking-tight">
          Visualization made simple and private.
          <span className="block mt-1 font-bold text-red-500">Local Charts. No Data Stored.</span>
        </p>
      </div>
