...
export const metadata: Metadata = {
  title: "Digital Signatures - Local Security Tools",
  description: "Sign any file or text string digitally and verify signatures securely using asymmetric cryptography. 100% private and runs in your browser.",
};
  ...
  return (
    <div className="flex-1 flex flex-col p-4 md:p-8 w-full max-w-6xl mx-auto min-h-[80vh]">
      <div className="mb-8 text-center max-w-2xl mx-auto">
        <h1 className="text-3xl md:text-4xl font-black text-slate-900 dark:text-white mb-2 tracking-tight">Digital Signatures</h1>
        <p className="text-slate-600 dark:text-slate-400 font-medium tracking-tight">
          Verify and sign digital documents with RSA-PSS security.
          <span className="block mt-1 font-bold text-red-500">Military-Grade. 100% Local.</span>
        </p>
      </div>
