...
export const metadata: Metadata = {
  ...
  description: "Locally format, minify, and validate JSON data.",
};
  ...
  return (
    <div className="flex-1 flex flex-col p-4 md:p-8 w-full max-w-6xl mx-auto min-h-[80vh]">
      <div className="mb-8 text-center max-w-2xl mx-auto">
        <h1 className="text-3xl md:text-4xl font-black text-slate-900 dark:text-white mb-2 tracking-tight">JSON Formatter</h1>
        <p className="text-slate-600 dark:text-slate-400 font-medium">Instantly beatify, minify, and validate JSON data. 100% processed securely in your browser.</p>
      </div>
