...
export const metadata: Metadata = {
  title: "Metadata Scrubber - Local Security Tools",
  description: "Remove EXIF metadata like GPS, camera info, and timestamps from your photos before sharing. 100% private.",
};

export default function MetadataScrubberPage() {
  return (
    <div className="flex-1 flex flex-col p-4 md:p-8 w-full max-w-6xl mx-auto min-h-[80vh]">
      <div className="mb-8 text-center max-w-2xl mx-auto">
        <h1 className="text-3xl md:text-4xl font-black text-slate-900 dark:text-white mb-2 tracking-tight">Metadata Scrubber</h1>
        <p className="text-slate-600 dark:text-slate-400 font-medium tracking-tight">
          Strip sensitive info from your photos instantly.
          <span className="block mt-1 font-bold text-red-500">Stay Anonymous. Stay Secure.</span>
        </p>
      </div>
