...
export const metadata: Metadata = {
  title: "Privacy Blur - Local Social Tools",
  description: "Protect your privacy by blurring faces, license plates, or sensitive documents locally in your browser. No data ever leaves your device.",
};
  ...
  return (
    <div className="flex-1 flex flex-col p-4 md:p-8 w-full max-w-6xl mx-auto min-h-[80vh]">
      <div className="mb-8 text-center max-w-2xl mx-auto">
        <h1 className="text-3xl md:text-4xl font-black text-slate-900 dark:text-white mb-2 tracking-tight">Privacy Blur</h1>
        <p className="text-slate-600 dark:text-slate-400 font-medium tracking-tight">
          Keep sensitive info private before sharing online.
          <span className="block mt-1 font-bold text-red-500">Local Processing. 100% Secure.</span>
        </p>
      </div>
