...
export const metadata: Metadata = {
  title: "SQL Formatter - Local Dev Tools",
  description: "Pretty-print and minify SQL queries for better readability. Supports various SQL dialects. 100% private.",
};
  ...
  return (
    <div className="flex-1 flex flex-col p-4 md:p-8 w-full max-w-6xl mx-auto min-h-[80vh]">
      <div className="mb-8 text-center max-w-2xl mx-auto">
        <h1 className="text-3xl md:text-4xl font-black text-slate-900 dark:text-white mb-2 tracking-tight">SQL Formatter</h1>
        <p className="text-slate-600 dark:text-slate-400 font-medium tracking-tight">
          Clean up messy SQL queries instantly.
          <span className="block mt-1 font-bold text-red-500">100% Client-side. No data leaks.</span>
        </p>
      </div>
