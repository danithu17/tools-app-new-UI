...
export const metadata: Metadata = {
  title: "SSH Key Generator - Local Security Tools",
  description: "Generate secure public and private SSH keys locally in your browser. Supports RSA and ED25519 (simulated). 100% private.",
};
  ...
  return (
    <div className="flex-1 flex flex-col p-4 md:p-8 w-full max-w-6xl mx-auto min-h-[80vh]">
      <div className="mb-8 text-center max-w-2xl mx-auto">
        <h1 className="text-3xl md:text-4xl font-black text-slate-900 dark:text-white mb-2 tracking-tight">SSH Key Generator</h1>
        <p className="text-slate-600 dark:text-slate-400 font-medium tracking-tight">
          Generate secure keys for your servers and git accounts.
          <span className="block mt-1 font-bold text-red-500">Local Generation. No Server Logs.</span>
        </p>
      </div>
