...
export const metadata: Metadata = {
  title: "Thumbnail Maker - Local Social Tools",
  description: "Create professional YouTube and social media thumbnails locally. Add text, filters, and overlays without uploading your photos.",
};
  ...
  return (
    <div className="flex-1 flex flex-col p-4 md:p-8 w-full max-w-6xl mx-auto min-h-[80vh]">
      <div className="mb-8 text-center max-w-2xl mx-auto">
        <h1 className="text-3xl md:text-4xl font-black text-slate-900 dark:text-white mb-2 tracking-tight">Thumbnail Maker</h1>
        <p className="text-slate-600 dark:text-slate-400 font-medium tracking-tight">
          Design high-impact thumbnails in seconds.
          <span className="block mt-1 font-bold text-red-500">Local Studio. 100% Private.</span>
        </p>
      </div>
