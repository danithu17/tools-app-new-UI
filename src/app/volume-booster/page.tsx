...
export const metadata: Metadata = {
  title: "Volume Booster - Local Audio Studio",
  description: "Safely increase or normalize audio volume without losing quality. 100% private and runs locally in your browser.",
};
  ...
  return (
    <div className="flex-1 flex flex-col p-4 md:p-8 w-full max-w-6xl mx-auto min-h-[80vh]">
      <div className="mb-8 text-center max-w-2xl mx-auto">
        <h1 className="text-3xl md:text-4xl font-black text-slate-900 dark:text-white mb-2 tracking-tight">Volume Booster</h1>
        <p className="text-slate-600 dark:text-slate-400 font-medium tracking-tight">
          Increase or normalize your audio levels safely.
          <span className="block mt-1 font-bold text-red-500">Local Processing. Zero Uploads.</span>
        </p>
      </div>
